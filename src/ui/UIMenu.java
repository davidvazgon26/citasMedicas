...
//Usamos static no porque sea necesario, sino para no crear instancias de un menu que solo muestra info en pantalla.
//Recuerda que static te permite invocar a los metodos de la clase sin necesidad de intanciarla
...
public class UIMenu {
    ...
    static void showPatientMenu(){
        ...
        do {
            System.out.println("\n\n");
            System.out.println("model.model.Patient");
